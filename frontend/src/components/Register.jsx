  ...
  return (
    <div className="max-w-md mx-auto px-4 py-16">
      <div className="glass rounded-2xl p-8">
        <h1 className="font-display text-2xl font-800 mb-6 gradient-text">Create account</h1>
        ...
        <p className="text-sm text-gray-400 mt-4">
          Already have an account? <Link to="/login" className="text-accentTo">Login</Link>
        </p>
      </div>
    </div>
  );
